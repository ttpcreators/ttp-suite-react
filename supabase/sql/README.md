...
| **Contacts : @Instagram + Ville** : colonnes `contacts.instagram` + `contacts.city` (fiches marques) | [`2026-09-08-contacts-instagram-city.sql`](2026-09-08-contacts-instagram-city.sql) | ⏳ **À faire** | À vérifier : anon `select=instagram,city` sur `contacts` = 200 ; colonne bidon = 400. |
