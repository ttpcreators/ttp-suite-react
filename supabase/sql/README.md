...
| [`13-events-writecheck-createur.sql`](13-events-writecheck-createur.sql) | 13 · Events write-check créateur | Durcissement RLS : `with check who = my_creator()` (un créateur ne peut plus injecter un event chez un autre via l'API) |
