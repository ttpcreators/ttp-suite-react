...
| **Tâches : sous-tâches + pièces jointes** : colonnes `todos.subtasks` + `todos.attachments` (jsonb) | [`todos-subtasks-attachments.sql`](todos-subtasks-attachments.sql) | ⏳ **À lancer** | — |
